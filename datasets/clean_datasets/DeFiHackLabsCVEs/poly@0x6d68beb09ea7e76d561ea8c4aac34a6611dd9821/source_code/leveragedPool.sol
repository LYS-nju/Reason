...
contract leveragedPool is leveragedData,safeTransfer{
    ...
    function buyLeverage(uint256 amount,uint256 minAmount,uint256 deadLine,bytes calldata ) external payable{
        _buy(leverageCoin,amount,minAmount,deadLine,true);
    }
    function buyHedge(uint256 amount,uint256 minAmount,uint256 deadLine,bytes calldata )  external payable{
        _buy(hedgeCoin, amount,minAmount,deadLine,true);
    }
    function buyLeverage2(uint256 amount,uint256 minAmount,uint256 deadLine,bytes calldata ) external payable{
        _buy(leverageCoin,amount,minAmount,deadLine,false);
    }
    function buyHedge2(uint256 amount,uint256 minAmount,uint256 deadLine,bytes calldata ) external payable{
        _buy(hedgeCoin, amount,minAmount,deadLine,false);
    }
    function sellLeverage(uint256 amount,uint256 minAmount,uint256 deadLine,bytes calldata ) external payable{
        _sell(leverageCoin,amount,minAmount,deadLine,true);
    }
    function sellHedge(uint256 amount,uint256 minAmount,uint256 deadLine,bytes calldata )  external payable{
        _sell(hedgeCoin, amount,minAmount,deadLine,true);
    }
    function sellLeverage2(uint256 amount,uint256 minAmount,uint256 deadLine,bytes calldata ) external payable{
        _sell(leverageCoin,amount,minAmount,deadLine,false);
    }
    function sellHedge2(uint256 amount,uint256 minAmount,uint256 deadLine,bytes calldata ) external payable{
