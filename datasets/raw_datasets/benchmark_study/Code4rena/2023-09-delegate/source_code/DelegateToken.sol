...
contract DelegateToken is ReentrancyGuard, IDelegateToken {
    ...
    function withdraw(uint256 delegateTokenId) external nonReentrant {
        ...
        delete delegateTokenInfo[delegateTokenId][DelegateTokenStorageHelpers.PACKED_INFO_POSITION]; // Deletes both expiry and approved
        ...
        if (delegationType == IDelegateRegistry.DelegationType.ERC721) {
            ...
            DelegateTokenStorageHelpers.writeUnderlyingAmount(delegateTokenInfo, delegateTokenId, 0); // Deletes amount
